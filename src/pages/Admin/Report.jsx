...
import {
  ...
  getAllRecordsEContent,
  getAllRecordsExaminationWork,

  getAllRecordsReviewer,

  getAllRecordsInnovativeTeaching,
...
const Report = () => {
  ...
  const tableRoutesMapping = (table) => {
    const tableRoute = {
      ...
      "e_content":getAllRecordsEContent,

      "examination_work": getAllRecordsExaminationWork,

      "reviewer": getAllRecordsReviewer,

      "innovative_teaching":getAllRecordsInnovativeTeaching,
