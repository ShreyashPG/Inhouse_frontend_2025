...
export default function Contribution() {
  ...
  const fetchRecord = async (tableName, table_id) => {
    try {
      ...
      console.log("id: ", id);
      console.log('Table name in conrtibution: ',tableName)
      if (table_id !== null) {
        const recordContributionURL = getRecordContributionByID(
          table_id,
          currentUser?.Username,
        );
        console.log('url: ', recordContributionURL);
        const response = await axios.get(recordContributionURL);
    ...
    useEffect(() => {
      ...
      console.log('table name: iis :::',tableNames)
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      // Send a POST request to the addRecordsBook API endpoint
      await axios.put(
       ` ${updateRecordsContribution}?username=${currentUser?.Username}&T_ID=${id}`,
