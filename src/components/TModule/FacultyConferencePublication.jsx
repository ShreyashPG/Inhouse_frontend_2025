...
import { getRecordsFacultyByID, addRecordsFaculty, uploadRecordsFaculty, updateRecordsFaculty } from "./API_Routes";
 ...
 const fetchRecord = async (tableName, table_id) => {
  try {
    ...
    if (table_id !== null) {
      ...
      const recordFacultyURL = getRecordsFacultyByID(
        table_id,
      ...
      //++++++++++++++++++++++++++++++++
      console.log("in faculty: ",recordFacultyURL);
      const response = await axios.get(recordFacultyURL);
      //++++++++++++++++++++++++++++++++++++++
      console.log("record response in faculty: ", response.data.data[0]);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      await axios.put(
        //+++++++++++++++++++++
       ` ${updateRecordsFaculty}?username=${currentUser?.Username}&T_ID=${id}`,
        //+++++++++++++++++++++
