...
import {
  ...
  getOneRecordsBook,
  getOneRecordsEContent,

  getOneRecordsExaminationWork,

  getOneRecordsReviewer,

  getOneRecordsInnovativeTeaching,
  ...
  deleteRecordsEContent,

  deleteRecordsExaminationWork,

  deleteRecordsReviewer,

  deleteRecordsInnovativeTeaching,
...
export default function TableData({ tableName }) {
  ...
  const getApiRoute = (tableName) => {
    ...
    const apiRoutes = {
      ...
      "E Content": (username) => getOneRecordsEContent(username),

      "Examination Work": (username) => getOneRecordsExaminationWork(username),

      "Reviewer": (username) => getOneRecordsReviewer(username),

      "Innovative Teaching": (username) => getOneRecordsInnovativeTeaching(username),
  ...
  const deleteAPIRoute = (tableName) => {
    const deleteRoutes = {
      ...
      "E Content": (username, T_ID) =>
        `${deleteRecordsEContent}?username=${username}&T_ID=${T_ID}`,

      "Examination Work": (username, T_ID) =>
         `${deleteRecordsExaminationWork}?username=${username}&T_ID=${T_ID}`,

      "Reviewer": (username, T_ID) =>
        `${deleteRecordsReviewer}?username=${username}&T_ID=${T_ID}`,

      "Innovative Teaching": (username, T_ID) =>
        `${deleteRecordsInnovativeTeaching}?username=${username}&T_ID=${T_ID}`,
  ...
  const updateAPIRoute = (tableName) => {
    const updateRoutes = {
      ...
      "E Content": (username, T_ID) =>
        `${updateRecordsEContent}?username=${username}&T_ID=${T_ID}`,

      "Examination Work": (username, T_ID) =>
        `${updateRecordsExaminationWork}?username=${username}&T_ID=${T_ID}`,

      "Reviewer": (username, T_ID) =>
        `${updateRecordsReviewer}?username=${username}&T_ID=${T_ID}`,

      "Innovative Teaching": (username, T_ID) =>
        `${updateRecordsInnovativeTeaching}?username=${username}&T_ID=${T_ID}`,
